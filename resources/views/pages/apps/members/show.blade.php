<x-default-layout>
    ...
    <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <div class="symbol symbol-100px symbol-circle mb-7">
                            <div class="symbol-label fs-3 {{ app(\App\Actions\GetThemeType::class)->handle('bg-light-? text-?', $member->name) }}">
                                {{ substr($member->name, 0, 1) }}
                            </div>
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $member->name }}</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                        ...
                        <!--begin::Info-->
                        <!--begin::Info heading-->
                        <div class="fw-bold mb-3">Preview
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">
                                <a href="#" class="text-gray-600 text-hover-primary">{{ $member->username }}</a>
                            </div>
                            <!--begin::Details item-->
                             <!--begin::Details item-->
                            <div class="fw-bold mt-5">Phone No</div>
                            <div class="text-gray-600">
                                <a href="#" class="text-gray-600 text-hover-primary">{{ $member->phone }}</a>
                            </div>
                            <!--begin::Details item-->
                             <!--begin::Details item-->
                            <div class="fw-bold mt-5">Nama Rekening</div>
                            <div class="text-gray-600">
                                <a href="#" class="text-gray-600 text-hover-primary">{{ $member->nama_rekening }}</a>
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Status</div>
                            <div class="text-gray-600">
                                <span class="badge {{ $member->deleted_at ? 'badge-danger' : 'badge-success' }}">
                                    {{ $member->deleted_at ? 'Inactive' : 'Active' }}
                                </span>
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Marketing Name</div>
                            <div class="text-gray-600">
                               {{ $member->marketing->name ?? "" }} ({{ $member->marketing->team->name ?? "-"  }})
                            </div>
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Last Deposit</div>
                            <div class="text-gray-600">{{ $member->last_deposit ? $member->last_deposit->format('d M Y, h:i A') : now()->format('d M Y, h:i A') }}</div>
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_user_view_overview_tab">Transactions</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
                    ...
                    <div class="card card-flush mb-6 mb-xl-9">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-title flex-column">
                                <h2 class="mb-1">List Transactions</h2>
                                ...
                                <div class="d-flex align-items-center position-relative my-5">
                                    ...
                                    <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Transactions" id="mySearchInputTransaction"/>
                                </div>
                                <!--end::Search-->
                            </div>
                            <!--end::Card title-->
    ...
    @push('scripts')
        {!! $transactionsTable->scripts() !!}
        <script>
            const searchInput = document.getElementById('mySearchInputTransaction');
            if (searchInput) {
